...
smd(
 ...
 smd({
   ...
   try {
     ...
     if (!_0x204f81) {
       return _0x55aba2.reply("*_Example : .tts Yo,I am KATAKURI_MD whatsapp bot._*");
     }
     try {
 ...
 smd({
   pattern: "sound",
    alias: ["KATAKURI_MD", "aine","mentalism","alive","waso"],
   ...
   try {
     ...
     let _0x4737bb = {
       audio: _0x2ba501,
       fileName: "katakuri_md tiktok Sound" + _0x19c223 + ".m4a",
       mimetype: "audio/mpeg",
       ptt: true,
 ...
 smd({
   ...
   try {
     ...
     try {
       ...
       let _0x4b47c3 = "./temp/katakuri-Md " + _0x1d542b[1] + ".mp3";
     ...
     let _0x300d1a = {
       ...
       mimetype: "audio/mpeg",
       fileName: "katakuri-Md--" + _0x1d542b[1] + ".mp3",
